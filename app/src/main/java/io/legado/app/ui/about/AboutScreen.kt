    ...
    AppScaffold(
        ...
        Column(
            ...
            Row(
                ...
                FilledTonalIconButton(onClick = { onIntent(AboutIntent.OpenUrl("https://github.com/Mupceet/EssentialReader")) }) {
                    Icon(
            ...
            SplicedColumnGroup(
                ...
                SettingItemWithDivider {
                    SettingItem(
                        ...
                        onClick = { onIntent(AboutIntent.OpenUrl("https://github.com/Mupceet/EssentialReader")) }
                    )
                }
                SettingItemWithDivider {
                    SettingItem(
