...
|---|---|---|---|---|
| body.font 正文字体 | 列表选择 | 系统预设×3 + 字体文件（系统无衬线） | textFont / systemTypefaces | 是 |
| body.weight 字重 | 滑条 | 100..900 步进100（500） | textBold | 是 |
| title.font 标题字体 | 列表选择 | +「跟随正文」（跟随正文） | titleFont | 是 |
| title.weight 标题字重 | 滑条 | 100..900 步进100（500） | titleBold | 是 |
